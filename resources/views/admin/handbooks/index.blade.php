...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <a href="{{ route('admin.handbooks.create') }}" class="btn btn-success pull-right">+Добавить</a>
        </div>
        <div class="box-body">
            {!! $dataTable->table() !!}
        </div>
        <div class="box-footer">
            ...
            <a class="btn ajax-delete-many btn-xs btn-danger" data-action="{{ route('admin.handbooks.deleteMany') }}">
