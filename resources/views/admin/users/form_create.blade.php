<div class="form-group">
    {{ Form::label('type', 'Частное лицо') }}
    {{ Form::radio('type', 'individual', true) }}
</div>

<div class="form-group">
    {{ Form::label('type', 'Юридическое лицо') }}
    {{ Form::radio('type', 'entity') }}
</div>

<div class="form-group">
    <div class="form-group">
        {{ Form::label('may_sell', 'Разрешить продавать (только для юр. диц)') }}
