...
@section('title', 'Личный кабинет — Мои товары — Все товары — Inlot.ru')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 col-sm-9">
                ...
                {{ Form::hidden('listCode', 'full_list', ['class' => 'goods-list-code']) }}
                ...
                <div id="result-list">
                    @include('cabinet.goods.partials.full_list')
                </div>
