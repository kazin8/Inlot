                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::select('rim_type_id', $data['types'], $rim->rim_type_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    <div class="input-group">
                                                        {{ Form::select('diameter', $data['diameters'], $rim->diameter, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    <div class="input-group">
                                                        {{ Form::select('width', $data['widthValues'], $rim->width, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                        <span class="input-group-addon">
                                                            дюймов
                                                        </span>
                                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::select('number_of_holes', $data['numberOfHolesValues'], $rim->number_of_holes, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::select('hole_diameter_id', $data['holeDiameters'], $rim->hole_diameter_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::select('radius_id', $data['radiuses'], $rim->radius_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::select('state_id', $data['states'], $rim->state_id, ['class'=>'form-control', 'data-item' => 'select-no-search', 'placeholder' => 'Выбрать...']) }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-9 col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                    {{ Form::file('gallery[]', ['data-max-file-count' => '10', 'data-input' => 'file', 'data-url' => route('goodsGallery', ['goods' => $goods->id]), 'multiple' => 'true', 'class' => 'file-loading form-control', 'accept' => 'image/*']) }}
                                                </div>
                                                <div class="col-xs-12 col-md-12 col-sm-12">
                                                </div>
                                            </div>
