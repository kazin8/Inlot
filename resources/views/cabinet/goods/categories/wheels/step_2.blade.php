                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('rim_type_id', $data['types'], $wheel->rim_type_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        <div class="input-group">
                                                            {{ Form::select('diameter', $data['diameters'], $wheel->diameter, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('seasonality_id', $data['seasonalities'], $wheel->seasonality_id, ['class'=>'form-control', 'data-item' => 'select-no-search', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('profile_width', $data['profileWidthValues'], $wheel->profile_width, ['class'=>'form-control', 'data-item' => 'select-no-search', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('profile_height', $data['profileHeightValues'], $wheel->profile_height, ['class'=>'form-control', 'data-item' => 'select-no-search', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        <div class="input-group">
                                                            {{ Form::select('wheels_width', $data['widthValues'], $wheel->width, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                            <span class="input-group-addon">
                                                                дюймов
                                                            </span>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        <label>Количество отверстий</label>
                                                    </div>
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('number_of_holes', $data['numberOfHolesValues'], $wheel->number_of_holes, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        <label>Диаметр расположения отверстий</label>
                                                    </div>
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('hole_diameter_id', $data['holeDiameters'], $wheel->hole_diameter_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        <label>Вылет (ЕТ)</label>
                                                    </div>
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('radius_id', $data['radiuses'], $wheel->radius_id, ['class'=>'form-control', 'data-item' => 'select', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('wheels_marks[]', $data['marks'], $data['activeMarks'], ['class'=>'form-control select-marks', 'data-item' => 'select', 'multiple' => 'true']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('wheels_models[]', $data['models'], $data['activeModels'], ['class'=>'form-control select-models', 'data-item' => 'select', 'multiple' => 'true']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                                        {{ Form::select('state_id', $data['states'], $wheel->state_id, ['class'=>'form-control', 'data-item' => 'select-no-search', 'placeholder' => 'Выбрать...']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
