...
@section('title', 'Купить '.$goods->name.', '.$goods->city->name.': цена, фото. Продажа автозапчатей на Inlot.ru')
@section('d', 'Купить '.$goods->name.': '.$autoPart->kind.', '.mb_strtolower($autoPart->state).' на торговой площадке Inlot.ru. Ознакомиться с ценами, фото, характеристиками и подробным описанием автозапчасти.')
