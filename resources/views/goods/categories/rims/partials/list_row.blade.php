...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <div class="product-item-vertical" data-item="product">
        ...
        <a class="product-item-vertical--link" href="{{ route('goods.item', ['goods' => $rim->goods->id]) }}"></a>
        <div class="product-item-vertical--content">
            <div class="product-item-vertical--img">
                <a href="{{ route('goods.item', ['goods' => $rim->goods->id]) }}"><img src="{{ $rim->goods->imagePath }}" alt="" class="full-width"></a>
            </div>
            <div class="product-item-vertical--description">
                <div>
                    <div class="product-item-vertical--name"><p><a href="{{ route('goods.item', ['goods' => $rim->goods->id]) }}">{{ $rim->goods->name }}</a></p></div>
                    <div class="product-item-vertical--price"><p>{{ $rim->goods->priceFormat }} ₽</p></div>
                ...
                <div class="width flex">
                    <div>
                        <div class="from">
                            ...
                            <div><p>{{ $rim->goods->city->name }}</p></div>
                        </div>
                        <div class="who">
                            <div><a href>{{ $rim->goods->companyName }}</a></div>
