...
@section('d', 'Купить колеса: новые и б/у. Продажа колес на торговой площадке Inlot.ru')
...
<section class="content">
    ...
    @include('includes.breadcrumbs')
        ...
        <div class="row">
            ...
            @include('goods.categories.wheels.includes.filter')
            ...
            <div class="col-xs-12 col-md-9 col-sm-9">
                ...
                <div class="row">
                    <div id="result-list" class="Product-item-grid">
                        @include('goods.categories.wheels.partials.list_row')
                    </div>
                </div>
                @if (count($wheels))
