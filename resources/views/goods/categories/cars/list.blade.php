...
@section('title', 'Продажа подержанных и новых автомобилей на торговой площадке Inlot.ru')
@section('d', 'Купить автомобиль: новые и c пробегом, продажа автомобилей на торговой площадке Inlot.ru')
...
<section class="content">
    <div class="container">
        ...
        <div class="row">
            ...
            @include('goods.categories.cars.includes.filter')
            ...
            <div class="col-xs-12 col-md-9 col-sm-9">
                ...
                <div class="row">
                    <div id="result-list" class="Product-item-grid">
                        @include('goods.categories.cars.partials.list_row')
                    </div>
                </div>
