...
@section('title', 'Заказ #34 — Inlot.ru')
                                    ...
                                    <div class="Order-total-block">
                                        ...
                                        <address class="contact-saller">
                                            ...
                                            @elseif (Auth::user()->type == 2)
                                                ...
                                                <p class="contact-saller-name">{{ $order->userCustomer->name }}</p>
                                                <p class="contact-saller-phone"><a href="tel:{{ $order->goods->user->phone }}">{{ $order->userCustomer->phone }}</a></p>
                                                <p class="contact-saller-mail"><a href="mailto:{{ $order->goods->user->email }}">{{ $order->userCustomer->email }}</a></p>
                                                <p class="contact-saller-address">{{ $order->goods->user->region }}, {{ $order->userCustomer->city }}</p>
                                            @endif
                                        </address>
                                        <div class="comment">
